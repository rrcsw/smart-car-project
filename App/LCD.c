...
extern uint8 right_black[80];
extern uint8 left_black[80];
uint8  mid_line[81];
extern float  Error;
...
extern int BlackEndM;
 ...
 /*LCD液晶变量定义*/
    ...
    Size_t size={100,80};                                //LCD显示区域图像大小
